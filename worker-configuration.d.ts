/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6a6aa83dcf8c661b14e539174dd18288)
...
declare namespace Cloudflare {
	...
	interface Env {
		ALLOWED_CHANNELS: "C09REGCDEA2,C0A21M6CWLU";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_CHANNELS" | "SLACK_BOT_TOKEN" | "SLACK_SIGNING_SECRET" | "GROQ_API_KEY" | "GROQ_MODEL" | "CREATOR_ID">> {}
}
declare module "*.md" {
	const value: string;
